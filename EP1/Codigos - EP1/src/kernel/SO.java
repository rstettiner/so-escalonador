...
public abstract class SO {
	...
	protected abstract void criaProcesso(Operacao[] codigo); //feito

	protected abstract void trocaContexto(PCB pcbAtual, PCB pcbProximo); //feito

	// Assuma que 0 <= idDispositivo <= 4
	protected abstract OperacaoES proximaOperacaoES(int idDispositivo); //TODO

	protected abstract Operacao proximaOperacaoCPU(); //TODO

	protected abstract void executaCicloKernel(); //TODO

	protected abstract boolean temTarefasPendentes(); //feito

	protected abstract Integer idProcessoNovo(); //feito

	protected abstract List<Integer> idProcessosProntos(); //feito

	protected abstract Integer idProcessoExecutando(); //feito

	protected abstract List<Integer> idProcessosEsperando(); //feito

	protected abstract List<Integer> idProcessosTerminados(); //feito

	protected abstract int tempoEsperaMedio(); //feito

	protected abstract int tempoRespostaMedio(); //feito

	protected abstract int tempoRetornoMedio(); //feito
	
	protected abstract int trocasContexto(); //feito
	
	public abstract void defineEscalonador(Escalonador e); //feito
}
